...
**Important:** Make sure your container is the same version as your host - if your host is Ubuntu 16.10, your container must be Ubuntu 16.10.
...
That's it! Take FFMPEG for a spin - try some encodes and see how fast it goes. If it works, let's install it!
